...
export default function Terminal({ hide }) {
  ...
  return (
    <div
      className={` absolute bottom-0 left-0 w-full z-9999  ${displayTerm ? "h-1/3 py-2" : "h-0 py-0"} ease-in-out overflow-hidden transition-200 transition-all flex border-t border-border bg-runner-bg px-4  flex-col flex`}
    >
      <Typewriter
