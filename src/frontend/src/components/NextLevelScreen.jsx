			...
			<div className="absolute  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/2 rounded-xl h-1/2 flex border border-white bg-bg"	>
				<div className="border border-white rounded-l-xl border-r w-11/16 h-full p-3">
					<div className='flex items-center'>
						...
						<div className='text-white text-3xl'>Příště trochu rychleji jo? </div>	
					</div>
					<div className='flex-col'>
						<div className='text-white text-3xl py-4 border-y border-white'>Skóre: 465</div>
						<div className='text-white text-3xl py-4 '>Peníze: 543</div>
						<div className='text-white text-3xl py-4 border-y border-white'>Čas: 5m 36s</div>	
							<div className='relative w-max h-max  '>	
								<img src={Circle} className='h-24 w-24 '/>
								<div className='absolute top-1/2 left-1/2 -translate-y-1/2 text-6xl -translate-x-1/2 text-white'>B</div>	
							</div>
						</div>
					</div>
